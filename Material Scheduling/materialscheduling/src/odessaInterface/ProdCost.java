...
/*
 * ProdCost holds manufacturing cost data for using various facilities. These values are used
 * for every mix, and can be updated by changing their textbox values with the Update button.
 * The Reset button changes the values back to their defaults.
 */
public class ProdCost extends JFrame {
	...
	/*
	 * Updates the variables and Excel file with the user-entered numbers
	 */
	private boolean update() {
		...
		try {
			FileInputStream inStream = new FileInputStream(new File("files/prodCost.xlsx"));
			XSSFWorkbook workBook = new XSSFWorkbook(inStream);
			Sheet sheet2 = workBook.getSheetAt(0); 
    		Iterator iterator = sheet2.iterator();
    		...
    		while (iterator.hasNext()) {   			
    			...
    			Iterator cellIterator = nextRow.cellIterator();			
	    			...
	    			while (cellIterator.hasNext()) {
	    			    ...
	    			    switch (columnIndex+1) {    			    			    
		    			    case 1:
		    			    	cell.setCellValue(Double.parseDouble(power.getText()));
		    			    	break;
		    			    case 2:
		    			    	cell.setCellValue(Double.parseDouble(oxygen.getText()));
		    			    	break;
		    			    case 3:
		    			    	cell.setCellValue(Double.parseDouble(time.getText()));
		    			    	break;
		    			    case 4:
		    			    	cell.setCellValue(Double.parseDouble(rgo.getText()));
		    			      	break;
		    			    case 5:
		    			    	cell.setCellValue(Double.parseDouble(tch.getText()));
		    			    	break;
		    			    case 6:
		    			    	cell.setCellValue(Double.parseDouble(crno.getText()));
		    			    	break;
		    			    case 7:
		    			    	cell.setCellValue(Double.parseDouble(chrome.getText()));
		    			    	break;
		    			    case 8:
		    			    	cell.setCellValue(Double.parseDouble(crni.getText()));
		    			    	break;
		    			    case 9:
		    			    	cell.setCellValue(Double.parseDouble(carbon.getText()));
		    			    	break;
		    			}
	    			}
    			}  
    		...
    		inStream.close();
    		FileOutputStream outStream = new FileOutputStream("files/prodCost.xlsx");
	...
	/*
	 * Resets the data in the Excel file and in the variables to their default values.
	 */
	private void reset() {
